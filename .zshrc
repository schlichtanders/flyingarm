...
plugins=(git, git-extras, git-flow, pip, python, sudo, wd, common-aliases, command-not-found, compleat, autojump, debian, dirhistory, zsh-completions, zsh-syntax-highlighting)
